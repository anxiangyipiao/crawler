...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(BaseSpiderObject):
    ...
    name = "dtdjzx_zhaopin"
    start_urls = 'https://www.dtdjzx.gov.cn/{type}/index_1.jhtml'
    ...
    county = ""  # 选填，爬虫区/县
    site_name = '灯塔-党建在线'
    source = 'www.dtdjzx.gov.cn'

    timeRange = 7
    max_page = 1

    detail_xpath = '//div[@class="title3 clearfix"]'
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//li[@class="none_list"]')
