...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(BaseSpiderObject):
    ...
    name = "hrss_yn_gov_zhaopin"
    start_urls = 'https://hrss.yn.gov.cn/NewsLsit.aspx?ClassID={type}&page=1'
    next_base_urls = 'https://hrss.yn.gov.cn/NewsLsit.aspx?ClassID={type}&page={page}'
    contents_base_urls = ''  # 用于拼接详情页网址
    province = "云南省"  # 必填，爬虫省份
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '云南省人力资源和社会保障政务门户'
    source = 'hrss.yn.gov.cn'

    timeRange = 7

    detail_xpath = '//table[@style="width:1025px"]'
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//ul[@class="ul13 pd20"]/li')
