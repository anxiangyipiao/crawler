...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(BaseSpiderObject):
    ...
    name = "hrss_gd_gov_zhaopin"
    start_urls = 'https://hrss.gd.gov.cn/zwgk/sydwzp/{type}/index.html'
    next_base_urls = 'https://hrss.gd.gov.cn/zwgk/sydwzp/{type}/index_{page}.html'
    contents_base_urls = ''  # 用于拼接详情页网址
    province = "广东省"  # 必填，爬虫省份
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '广东省人力资源和社会保障厅网站'
    source = 'hrss.gd.gov.cn'


    timeRange = 7
    max_page = 1

    detail_xpath = '//div[@class="marB40 clearfix"]'
