...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(BaseSpiderObject):
    ...
    name = "rst_hubei_gov_zhaopin"
    start_urls = 'https://rst.hubei.gov.cn/bmdt/ztzl/ywzl/hbsszsydwgkzp/{type}/index.shtml'
    next_base_urls = 'https://rst.hubei.gov.cn/bmdt/ztzl/ywzl/hbsszsydwgkzp/{type}/index_{page}.shtml'
    contents_base_urls = ''  # 用于拼接详情页网址
    province = "湖北省"  # 必填，爬虫省份
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '湖北省人力资源和社会保障厅'
    source = 'rst.hubei.gov.cn'


    timeRange = 7
    max_page = 1

    detail_xpath = '//div[@class="view TRS_UEDITOR trs_paper_default trs_word"]'
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//ul[@class="list-t border6"]/li')
