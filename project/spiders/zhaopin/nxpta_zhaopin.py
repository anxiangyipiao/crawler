...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(BaseSpiderObject):
    ...
    name = "nxpta_zhaopin"
    start_urls = 'https://www.nxpta.com/{type}/index.html'
    next_base_urls = 'https://www.nxpta.com/{type}/index_{page}.html'
    contents_base_urls = ''  # 用于拼接详情页网址
    province = ""  # 必填，爬虫省份
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '宁夏回族自治区人事考试中心'
    

    timeRange = 7
    max_page = 1

    detail_xpath = '//div[@class="con_text"]'
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//p[@class="title-li"]')
