...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(BaseSpiderObject):
    ...
    name = "hrss_beijing_gov_zhaopin"
    start_urls = 'https://rsj.beijing.gov.cn/xxgk/{type}/index.html'
    next_base_urls = 'https://rsj.beijing.gov.cn/xxgk/{type}/index_{page}.html'
    ...
    detail_xpath = '//div[@class="container"]'
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//div[@class="listBox"]/ul/li')
