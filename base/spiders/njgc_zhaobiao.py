...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "njgc_zhaobiao"
    start_urls = 'https://njgc.jfh.com/app/openTenderNotice/queryPage'
    
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://njgc.jfh.com/purchase/detail?id={id}&type=1'  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址
    ...
    def parse(self, response):
        ...
        for node in node_list:
            ...
            item['publish_time'] = node['releaseTime'][:10]
