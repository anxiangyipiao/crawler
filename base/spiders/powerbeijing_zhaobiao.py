...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "powerbeijing_zhaobiao"
    start_urls = 'https://www.powerbeijing-ec.com/jncms/search/search_result.html?categoryIds=2&tabName=%E5%85%AC%E5%91%8A%E5%88%97%E8%A1%A8&goSearch=&page={page}'       
    ...
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '北京京能电子商务平台'
    source = 'www.powerbeijing-ec.com'
    max_page = 20
