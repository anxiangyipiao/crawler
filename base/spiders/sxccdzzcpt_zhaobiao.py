...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "sxccdzzcpt_zhaobiao"
    start_urls = 'https://shanxisheng-zfcgdzmcgov.cn/gpfa-bpoc/api/notice/kc/v1/ignore/pagingKcAgreementNotice'
    ...
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '山西省政府采购电子目录'
    source = 'shanxisheng-zfcgdzmcgov.cn'
    max_page = 20
    ...
    def parse(self, response):
        ...
        node_list  = xmltodict.parse(response.text)['RestResponse']['data']['data']['data']
        ...
        for node in node_list:
            ...
            item['url'] = self.contents_base_urls + node['path']
            ...
            if add_task == False:
                    ...
                    yield scrapy.Request(item['url'],method='get',callback=self.parse_detail,dont_filter=True,meta={'item':item},headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3'})
