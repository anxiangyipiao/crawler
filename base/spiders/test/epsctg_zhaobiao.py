...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "epsctg_zhaobiao"
    start_urls = 'https://eps.ctg.com.cn/cms/channel/1ywgg1/index.htm?pageNo={page}'
    
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://eps.ctg.com.cn'  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址

    province = ""  # 必填，爬虫省份
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '中国三峡集团电子采购平台'
    source = 'eps.ctg.com.cn'
    max_page = 20
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//li[@name="li_name"]')
        ...
        for node in node_list:
            ...
            item['publish_time'] = node.xpath('./a/em/text()').extract_first().strip()[:10]
