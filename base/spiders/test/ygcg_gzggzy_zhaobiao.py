...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "ygcg_gzggzy_zhaobiao"
    start_urls = 'https://ygcg.gzggzy.cn/content/page?channelIds=2306&channelOption=1&orderBy=27&size=15&page={page}&title=&rangType=&purchaser=&supervisionCompanyName='
    ...
    county = ""  # 选填，爬虫区/县
    site_name = '广州市阳光采购网'
    source = 'ygcg.gzggzy.cn'
    max_page = 20

    headers = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3',
        'referer':'https://ygcg.gzggzy.cn/p92/cggg.html',
        'host':'ygcg.gzggzy.cn',
    }
    ...
    def parse(self, response):
        ...
        node_list  = response.json()['data']['content']
        ...
        for node in node_list:
            ...
            item['url'] = self.contents_base_urls + node['h5UrlWhole']
