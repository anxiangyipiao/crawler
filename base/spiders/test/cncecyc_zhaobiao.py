...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "cncecyc_zhaobiao"
    start_urls = [
        'https://bid.cncecyc.com/cms/channel/ywgg1hw/index.htm?pageNo={page}', 
        'https://bid.cncecyc.com/cms/channel/ywgg1gc/index.htm?pageNo={page}',   
        ]
    
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://bid.cncecyc.com'  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址

    province = ""  # 必填，爬虫省份
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '中国化学电子招标投标交易平台'
    source = 'bid.cncecyc.com'
    max_page = 10
    ...
    def parse(self, response):
        ...
        for node in node_list:
            ...
            item['publish_time'] = node.xpath('./a/span[3]/text()').extract_first().strip()
