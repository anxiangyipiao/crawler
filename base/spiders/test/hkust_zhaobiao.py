...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "hkust_zhaobiao"
    start_urls = [
        'https://puro.hkust-gz.edu.cn/purchase/portal/portalArticle/article/column/list?total=856&pageNum={page}&pageSize=20&columnId=18&location=2', 
        'https://cg.ccteg.cn/cms/channel/ywgg1hw/index.htm?pageNo={page}',
        'https://puro.hkust-gz.edu.cn/purchase/portal/portalArticle/article/column/list?total=4431&pageNum={page}&pageSize=20&columnId=8&location=2'
        ]
    
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://puro.hkust-gz.edu.cn/bid/detail?id='  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址

    province = ""  # 必填，爬虫省份
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '香港科技大学(广州)采购处'
    source = 'puro.hkust-gz.edu.cn'
    max_page = 10
    ...
    def start_requests(self):
        ...
        for url in self.start_urls:
            ...
            yield scrapy.Request(param,method='get',callback=self.parse,dont_filter=True,meta={'page':1,"param":url},headers=self.headers)
    ...
    def parse(self, response):
        ...
        node_list  = response.json()['data']['rows']
