...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "czjyancheng_zhaobiao"
    start_urls = [
        'https://czj.yancheng.gov.cn/col/col31689/index.html?uid=135580&pageNum={page}', 
        'https://czj.yancheng.gov.cn/col/col31691/index.html?uid=135580&pageNum={page}',    
        'https://czj.yancheng.gov.cn/col/col20179/index.html?uid=135567&pageNum={page}',  
        'https://czj.yancheng.gov.cn/col/col20177/index.html?uid=135567&pageNum={page}',
        'https://czj.yancheng.gov.cn/col/col20176/index.html?uid=135567&pageNum={page}',
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//ul[@class="column-list bt-all bt-lists-cover"]/li')
