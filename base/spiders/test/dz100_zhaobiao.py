...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "dz100_zhaobiao"
    start_urls = 'https://api.dz100.com/bid/bidding/info/home/findProcurementNotice?pageNum={page}&pageSize=10'
    ...
    def parse(self, response):
        ...
        for node in node_list:
            ...
            item['publish_time'] = node['proStartTime'][:10]

            if node['proUrl'] != None and node['proUrl'] != '':
                item['url'] = node['proUrl']
            else:
