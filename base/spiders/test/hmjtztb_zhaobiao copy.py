...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "hmjtztb2_zhaobiao"
    start_urls = 'http://www.hmjtztb.com/search.jspx?startDate=&endDate=&sdata=10000&exAAcgfs=&exAAyzjc=&exAAhangye=&exAApinlei=&channelId=590&fid=552&q='
        
    
    next_base_urls = 'http://www.hmjtztb.com/search_{page}.jspx?startDate=&endDate=&sdata=10000&exAAcgfs=&exAAyzjc=&exAAhangye=&exAApinlei=&channelId=590&fid=552&q=' # 用于下一页网址拼接
