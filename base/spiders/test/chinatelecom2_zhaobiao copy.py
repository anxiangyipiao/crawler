...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "chinatelecom2_zhaobiao"
    start_urls = 'https://caigou.chinatelecom.com.cn/portal/base/announcementJoin/queryListNew'
    
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://caigou.chinatelecom.com.cn/DeclareDetails?id={id}&type=4&docTypeCode={TypeCode}'  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址
    ...
    def parse_detail(self, response):
        ...
        item['contents'] = response.json()['data']['remark']
        yield item
