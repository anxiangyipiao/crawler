...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "zcpt_zhaobiao"
    start_urls = 'https://zcpt.cebenvironment.com.cn/cms/category/iframe.html?.html?searchDate=1999-10-10&dates=300&categoryId=2&tabName=%E6%8B%9B%E6%A0%87%E5%85%AC%E5%91%8A&precise=&status=&tenderno=&goSearch=&tenderMethod=&page={page}'
    ...
    county = ""  # 选填，爬虫区/县
    site_name = '中国光大环境'
    source = 'zcpt.cebenvironment.com.cn'
    max_page = 20
    ...
    def parse(self, response):
        ...
        for node in node_list:
            ...
            item['publish_time'] = node.xpath('./a/@href').extract_first().strip().split('/')[-2]
    ...
    def parse_detail(self, response):
        ...
        item['contents'] = response.xpath('//iframe/@src').extract_first()
        yield item
