...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "sinopec_zhaobiao"
    start_urls = 'https://ec.sinopec.com/f/supp/bid/queryBidNotices.do'
    
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://ec.sinopec.com/f/supp/notice/bidNotice.do?id='  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址

    province = ""  # 必填，爬虫省份
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '中国石化电子采购平台'
    source = 'ec.sinopec.com'
    max_page = 20
    ...
    def parse(self, response):
        ...
        node_list  = response.json()['result']['result']
        ...
        for node in node_list:
            ...
            item['publish_time'] = datetime.datetime.fromtimestamp(node['createdate']["time"]/1000).strftime('%Y-%m-%d')
