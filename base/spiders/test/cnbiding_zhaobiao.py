...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "cnbiding_zhaobiao"
    start_urls = 'http://cnbiding.com.cn/news/list.php?catid=4&page={page}'       
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//div[@class="layui-tab-item layui-show rightbox-content"]/ul/li')
        ...
        for node in node_list:
            ...
            item['title'] = node.xpath('./a/span[1]/text()').extract_first().strip()
