...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "hgdzzb_zhaobiao"
    start_urls = 'https://hgdzzb.nbport.com.cn/zjhgcms/category/iframe.html?searchDate=1999-10-12&dates=300&goSearch=&tabName=%E6%8B%9B%E6%A0%87%E5%85%AC%E5%91%8A&status=&precise=%E9%9B%86%E5%9B%A2&categoryId=2&page={page}'
    ...
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '浙江海港电子招标采购平台'
    source = 'hgdzzb.nbport.com.cn'
    max_page = 10
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//ul[@class="newslist"]/li')
        ...
        for node in node_list:
            ...
            item['title'] = node.xpath('./a/div/div[2]/h5/text()').extract_first().strip()
            item['publish_time'] = node.xpath('./a/div/div[3]/div/text()').extract_first().strip()
