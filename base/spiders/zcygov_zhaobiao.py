...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "zcygov_zhaobiao"
    start_urls = 'https://mall.anhui.zcygov.cn/announcement/lobby/queryPage'
    ...
    form = {"pageSize":10,"pageNo":1,"announcementTypes":[8018],"district":"349900","all":{"blackList":[],"whiteList":[]}}
    ...
    def parse(self, response):
        ...
        node_list  = response.json()['result']['data']
        ...
        for node in node_list:
            ...
            publish_time = datetime.fromtimestamp(node['updateTime']/1000).strftime('%Y-%m-%d')
            item['publish_time'] =  publish_time


            if  'http' in  node['outUrl']:
                item['url'] =  node['outUrl']
            else:
                item['url'] =  'https://mall.anhui.zcygov.cn' + node['outUrl']
