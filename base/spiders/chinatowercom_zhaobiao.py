...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "chinatowercom_zhaobiao"
    start_urls = [
        'https://ebid.chinatowercom.cn/zgtt/gggs/003001/detailpage.html',   
        ]
    
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://ebid.chinatowercom.cn'  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//ul[@class="sub-items"]/li')
