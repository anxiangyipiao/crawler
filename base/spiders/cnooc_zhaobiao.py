...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "cnooc_zhaobiao"
    start_urls = 'https://buy.cnooc.com.cn/cbjyweb/001/001001/{page}.html'       
        
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://buy.cnooc.com.cn'  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址
    province = ""  # 必填，爬虫省份
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '中国海洋石油集团有限公司'
    source = 'buy.cnooc.com.cn'
    max_page = 20
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//li[@class="now-hd-items clearfix"]')
