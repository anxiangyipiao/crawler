...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "sdhsg_zhaobiao"
    start_urls = 'https://api.sdhsg.com/api/tendering/tenderinglist?page={page}&pageSize=25&projecttype=0&announcementtype=1&level=1'
    
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://www.sdhsg.com/technology/newBiddetails?id={id}&index=0&page=3&chooseValue=1&firstTile=%E6%8B%9B%E6%A0%87%E4%B8%93%E5%8C%BA%2F%E6%8B%9B%E6%A0%87%E5%85%AC%E5%91%8A'  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址
    ...
    def parse(self, response):
        ...
        node_list  = response.json()['data']['data']
        ...
        for node in node_list:
            ...
            item['publish_time'] = datetime.datetime.utcfromtimestamp(node['create_time']).strftime('%Y-%m-%d %H:%M:%S')[:10]
            ...
            if add_task == False:
                ...
                content_url = 'https://api.sdhsg.com/api/tendering/detail?id={id}'.format(id=node['id'])
