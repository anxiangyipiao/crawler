...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "eavic_zhaobiao"
    start_urls = 'https://www.eavic.com/rest/portal/getPgeTenderNotice'
    
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://www.eavic.com/rest/article/getTenderInfo?id={id}'  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址

    province = ""  # 必填，爬虫省份
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '中国航空工业集团有限公司'
    source = 'www.eavic.com'
    max_page = 20
    ...
    def parse(self, response):
        ...
        for node in node_list:
            ...
            item['publish_time'] = datetime.datetime.fromtimestamp(node['createTime']/1000).strftime('%Y-%m-%d')
