...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "shudaojt_zhaobiao"
    start_urls = [
        'https://zb.shudaojt.com/zbgg/zhaobiao.html',      
        ]
    
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://zb.shudaojt.com'  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址

    province = ""  # 必填，爬虫省份
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = '蜀道投资集团有限责任公司集中招标采购平台'
    source = 'zb.shudaojt.com'
    max_page = 10
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath('//div[@class="list-details-right-single"]')
        ...
        for node in node_list:
            ...
            item['publish_time'] = node.xpath('./div[2]/div[2]/text()').extract_first().strip()
