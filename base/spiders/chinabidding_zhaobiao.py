...
class Shandong_JiNan_ggzy_jianshegongcheng_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "chinabidding_zhaobiao"
    start_urls = 'https://chinabidding.mofcom.gov.cn/zbwcms/front/bidding/bulletinInfoList'
    
    next_base_urls = ''  # 用于下一页网址拼接
    contents_base_urls = 'https://chinabidding.mofcom.gov.cn/bidDetail'  # 用于拼接详情页网址
    page_urls = ""  # 用于获取下一页网址
    ...
    county = ""  # 选填，爬虫区/县
    site_name = '中国国际招标网'
    source = 'chinabidding.mofcom.gov.cn'
    max_page = 10
    ...
    def parse(self, response):
        ...
        for node in node_list:
            ...
            item['url'] = self.contents_base_urls + node['filePath']
