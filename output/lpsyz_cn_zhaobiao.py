...
class template_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "lpsyz_cn_zhaobiao"
    start_urls = [
       "https://www.lpsyz.cn/xydt/tzgg.htm",  # 招标信息列表页
    ]
    ...
    city = ""  # 必填，爬虫城市
    county = ""  # 选填，爬虫区/县
    site_name = "六盘水幼儿师范高等专科学校"  # 必填，爬虫网站名称
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath("//div[@class='container list-container ny_mani']//ul//li")
