...
class template_zhaobiao(ZhaotoubiaoBaseSpider):
    ...
    name = "cuhf_edu_cn_zhaobiao"
    start_urls = [
       "https://www.cuhf.edu.cn/180/list.htm",  # 招标信息列表页
    ]
    ...
    def parse(self, response):
        ...
        node_list  = response.xpath("//div[@class='col_news_list listcon']//ul[@class='news_list list2']//li")
